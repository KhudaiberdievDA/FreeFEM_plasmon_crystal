...
/* Parameters. */
period = 8.0;				// Real period of the stripes [um].
stripe = (period - 1.5) / period;	// Fraction of metal.
d = 714.0 / period;			// Dielectric thickness.
t = 0.22 / period;			// Depth of 2D system below surface.
...
Curve Loop(3) = {20, -25, -11, -22, -21, -5, -24};
Plane Surface(3) = {3};
...
Physical Curve("l_boundary") = {1, 2, 3, 4, 24, 5, 6, 7,
    9, 10, 11, 25, 12, 13, 14, 15};
Physical Curve("l_gate") = {22};
Physical Curve("l_back") = {21};
Physical Curve("l_stripe") = {26};
